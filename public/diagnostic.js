...
let newCart = Cart.create({
  orders: [
    Ember.Object.create({quantity: 2, product: "hat!", price: 5}),
    Ember.Object.create({quantity: 1, product: "desk lamp", price: 20}),
    Ember.Object.create({quantity: 3, product: " hand towels", price: 8}),
